...
- **FR-06.1 তৈরির সময় ইমেজ আপলোড (Upload on Creation):** নতুন টুডু তৈরি করার ফর্মেই ঐচ্ছিকভাবে একটি ছবি বাছাই করা যাবে; টুডু তৈরি হওয়ার পরপরই সেই ছবিটি আপলোড হয়ে যায়।
- **FR-06.2 থাম্বনেইল প্রিভিউ (Thumbnail Preview):** ছবি সংযুক্ত থাকা প্রতিটি টুডু কার্ডে একটি ছোট থাম্বনেইল প্রিভিউ দেখা যাবে।
- **FR-06.3 ছবি প্রতিস্থাপন (Image Replace):** Edit Todo ডায়ালগ থেকে বিদ্যমান ছবির প্রিভিউ দেখে নতুন ছবি দিয়ে তা প্রতিস্থাপন করা যাবে।
- **FR-06.4 ছবি অপসারণ (Image Removal):** Edit Todo ডায়ালগ থেকে সংযুক্ত ছবিটি স্থায়ীভাবে সরিয়ে ফেলা যাবে (স্টোরেজ থেকেও ফাইলটি মুছে যায়, শুধু ডাটাবেস রেফারেন্স নয়)।
- **FR-06.5 স্বয়ংক্রিয় অপটিমাইজেশন (Optimization):** আপলোড করা ছবি Sharp লাইব্রেরির মাধ্যমে রিসাইজ (সর্বোচ্চ 800px) এবং আধুনিক WebP ফরম্যাটে সংকুচিত হবে।
- **FR-06.6 ডুয়েল স্টোরেজ (Dual Storage):** AWS S3 কনফিগার করা থাকলে ক্লাউডে, নতুবা লোকাল ফোল্ডারে (`public/uploads/`) সংরক্ষিত হবে।
- **FR-06.7 ভ্যালিডেশন (File Validation):** শুধু ইমেজ ফাইল (`image/*`) গ্রহণযোগ্য এবং সর্বোচ্চ সাইজ ৫MB — এর বাইরে গেলে স্পষ্ট এরর দেখানো হবে (ক্লায়েন্ট ও সার্ভার উভয় পাশে)।
- **FR-06.8 মালিকানা যাচাই (Ownership Enforcement):** একজন ব্যবহারকারী কেবল তার নিজের টুডুর ছবি আপলোড, প্রতিস্থাপন বা অপসারণ করতে পারবেন — প্রতিটি অপারেশনে `userId` বাধ্যতামূলকভাবে যাচাই হয়।
